...
The results from Experiment 1 showed that when there were gender differences in preferences for short-term mating, there was no gender difference in the average number of short-term mating experiences among the full population of heterosexual individuals (*M~men~* = `r m_exp_all.mean_011`, *SD~men~* = `r m_exp_all.sd_011`; *M~women~* = `r f_exp_all.mean_011`, *SD~women~* = `r f_exp_all.sd_011`), Cohen's *d* = `r exp_all.d_011`. Nor was there a difference in the average number of short-term mates (*M~men~* = `r m_partner_all.mean_011`, *SD~men~* = `r m_partner_all.sd_011`; *M~women~* = `r f_partner_all.mean_011`, *SD~women~* = `r f_partner_all.sd_011`), Cohen's *d* = `r partner_all.d_011` (Figure \ref{fig:men_vs_women}).
