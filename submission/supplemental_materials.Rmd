...
\textbf{Supplemental Table B1: Mean proportion of heterosexual men and women in the mating pool and its standard deviation after 1,000 time steps in the model.}
...
### Sensitivity Analysis on Gender Differences in Short-term Mating Behaviors in the Full Population
...
\begin{figure}[h]
  ...
  \caption{\textbf{Short-term mating behaviors of men and women for 0-8\% long-term relationship likelihood when gender differences existed in mating preferences.} Line plots summarizing the outcome variables separately for heterosexual individuals and gay men and lesbian women. Plot (A) shows the average number of short-term mating experiences, and plot (B) shows the average number of short-term mates. The points show mean values and whiskers represent standard errors, but the standard errors are small and overlap to form a single bar in some sets of parameter setting. The means were calculated using the full population of men and women in the model (\textit{N\textsubscript{men}} = \textit{N\textsubscript{women}} = 150).}
...
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Men} & \multicolumn{2}{c}{Women} & \multicolumn{2}{c}{ } & \multicolumn{2}{c}{Men} & \multicolumn{2}{c}{Women} & \multicolumn{2}{c}{ } \\
...
\addlinespace
\multicolumn{13}{l}{\textit{Experiment 2: Gay men and lesbian women}} \\
...
\begin{tablenotes}
\small
\item \textit{Note.} \textit{M} = Mean. \textit{SD} = Standard deviation. CI = Confidence interval. LL = Lower limit. UL = Upper limit. The means were calculated using the full population of men and women in the model (\textit{N\textsubscript{men}} = \textit{N\textsubscript{women}} = 150).
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\begin{figure}[h]
  ...
  \caption{\textbf{Short-term mating behaviors of heterosexual men and women in the mating pool for 0-8\% long-term relationship likelihood when gender differences existed in mating preferences.} Line plots summarizing the outcome variables. Plot (A) shows the average number of short-term mating experiences in the mating pool, and plot (B) shows the average number of short-term mates in the mating pool. Central points show mean values and whiskers represent standard errors, but the standard errors are small and overlap to form a single bar in some sets of parameter setting. The means were calculated using the population of heterosexual men and women who successfully participated in the mating pool (See Table C2 for the mean and standard deviation of the proportion of individuals in the mating pool).}
...
\caption{\textbf{Proportion and short-term mating behaviors of heterosexual men and women in the mating pool for 0-8\% long-term relationship likelihood when gender differences existed in mating preferences}}
\centering
\begin{threeparttable}
\resizebox{\linewidth}{!}{
...
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Men} & \multicolumn{2}{c}{Women} & \multicolumn{2}{c}{ } & \multicolumn{2}{c}{Men} & \multicolumn{2}{c}{Women} & \multicolumn{2}{c}{ } & \multicolumn{2}{c}{Men} & \multicolumn{2}{c}{Women} & \multicolumn{2}{c}{ } \\
...
\begin{tablenotes}
\small
\item \textit{Note.} \textit{M} = Mean. \textit{SD} = Standard deviation. CI = Confidence interval. LL = Lower limit. UL = Upper limit. The means were calculated with \\ subsamples of men and women who had ever engaged in short-term mating behaviors.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
### Sensitivity Analysis on the Comparison Between Heterosexual and Gay Men

\renewcommand{\thefigure}{C3}
\begin{figure}[h]
  \centering
  \includegraphics{figures/sa_fig3_hetero_vs_gay_men.pdf}
  \caption{\textbf{Short-term mating behaviors of heterosexual men and gay men for 0-8\% long-term relationship likelihood when gender differences existed in mating preferences.} Line plots summarizing the outcome variables. Plot (A) shows the average number of short-term mating experiences, and plot (B) shows the average number of short-term mates. Central points show mean values and whiskers represent standard errors, but the standard errors are small and overlap to form a single bar in some sets of parameter setting. The means were calculated using the full population of heterosexual men and gay men in the model (\textit{N\textsubscript{hetero}} = \textit{N\textsubscript{gay}} = 150).}
...
\multicolumn{1}{c}{ } & \multicolumn{6}{c}{Average short-term mating experiences} & \multicolumn{6}{c}{Average short-term mates} \\
\cmidrule(l{3pt}r{3pt}){2-7} \cmidrule(l{3pt}r{3pt}){8-13}
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{\makecell[c]{Heterosexual\\men}} & \multicolumn{2}{c}{Gay men} & \multicolumn{2}{c}{ } & \multicolumn{2}{c}{\makecell[c]{Heterosexual\\men}} & \multicolumn{2}{c}{Gay men} & \multicolumn{2}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5} \cmidrule(l{3pt}r{3pt}){8-9} \cmidrule(l{3pt}r{3pt}){10-11}
\multicolumn{1}{c}{\makecell[c]{Long-term\\Likelihood\\(\%)}} & \multicolumn{1}{c}{\em{M}} & \multicolumn{1}{c}{\em{SD}} & \multicolumn{1}{c}{\em{M}} & \multicolumn{1}{c}{\em{SD}} & \multicolumn{1}{c}{\makecell[c]{Mean difference\\95\%CI [LL, UL]}} & \multicolumn{1}{c}{\makecell[c]{Cohen's \\ \em{d}}} & \multicolumn{1}{c}{\em{M}} & \multicolumn{1}{c}{\em{SD}} & \multicolumn{1}{c}{\em{M}} & \multicolumn{1}{c}{\em{SD}} & \multicolumn{1}{c}{\makecell[c]{Mean difference\\95\%CI [LL, UL]}} & \multicolumn{1}{c}{\makecell[c]{Cohen's \\ \em{d}}}\\
\midrule
...
\begin{tablenotes}
\small
\item \textit{Note.} \textit{M} = Mean. \textit{SD} = Standard deviation. CI = Confidence interval. LL = Lower limit. UL = Upper limit. The means were calculated using the full population of heterosexual men and gay men in the model (\textit{N\textsubscript{hetero}} = \textit{N\textsubscript{gay}} = 150).
\end{tablenotes}
\end{threeparttable}
\end{table}
