...
The model included two types of entities: global and agents. In this model, time and space were modeled as discrete variables. During each time step, agents executed the commands described in the schedule. Space was represented as discrete locations on a two-dimensional 33*33 lattice. All state variables are summarized in Table S1.

### Process overview and scheduling

The model was written using Netlogo 6.2.1 **citation needed**. The model proceeded in discrete time steps, and the entities executed commands in the following order:
