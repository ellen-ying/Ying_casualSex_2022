...
1.43, \emph{SD\textsubscript{women}} = 0.24), Cohen's \emph{d} = 0.00.
Nor was there a difference in the average number of short-term mates
(\emph{M\textsubscript{men}} = 0.80, \emph{SD\textsubscript{men}} =
0.11; \emph{M\textsubscript{w}} = 0.80, \emph{SD\textsubscript{women}} =
0.11), Cohen's \emph{d} = 0.00 (Figure 1).
