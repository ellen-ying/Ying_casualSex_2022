;; Model 1.3: heterosexual only with long-term relationship possible, with desirability and limited movement range
;; sex ratio as a parameter
...
to short-term-mate ;; turtle procedure: check to have short-term mating
  ...
  if target != nobody [
    ...
    let meet-stadard? [ desirability ] of target > mating-standard and
                      [ desirability ] of self > [ mating-standard ] of target

    ;; check if both of us feel like having sex and decide whetehr to do it
    if ([mating-decision] of target = 1) and meet-stadard? [
...
1078
146
Plotting the number of sexual partners of males and females among single and coupled agents 
11
0.0
1
