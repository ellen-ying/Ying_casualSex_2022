;; Model 3.1: All-homosexual mode added, counting short-term matings
...
turtles-own [
  ...
  initiator?                 ;; (only in all-gay model) whether a turtle initiates coupling
...
to go
  ...
  ;; in all-gay model, initiators decide on mating
  ;; in heteorsexual-only model, females decide on mating
...
to decide-short-term ;; turtle procedure: to decide on short-term mating
  ;; reset decision on short-term mating
  set short-term-mate? false
...
to set-initiator ;; turtle procedure: to set initiators
  ;; reset intiator status
  ask turtles [ set initiator? false ]

  ;; in each tick, set half of turtles to be initiator
  let male-initiator (number-of-male / 2)
  let female-initiator (300 - number-of-male) / 2
...
to short-term-mate ;; turtle procedure: check to have short-term mating
  ;; to check if there someone else nearby who is not my partner
  ;; in all-gay model, choose someone with the same gender
  ;; in heteorsexual-only model, choose someone with a different gender
  let target one-of other turtles-here with [ partner != myself and condition? ]
...
to long-term-mate ;; turtle procedure: check to have long-term mating
  ;; check to see whether there is an uncoupled individual
  ;; in all-gay model, choose someone with the same gender
  ;; in heteorsexual-only model, choose someone with a different gender
  let potential-partner one-of other turtles-here
    with [ not coupled? and condition? ]
...
to update-plot ;; plotting procedure
  ...
  plot count turtles with [color = turquoise and coupled?] / number-of-male
  set-current-plot-pen "Female"
  plot count turtles with [color = orange and coupled?] / (300 - number-of-male)
  ...
  set-current-plot "Short-term mating 1"
  set-current-plot-pen "Male"
  plot mean [short-term-count] of turtles with [ color = turquoise ]
  set-current-plot-pen "Female"
  plot mean [short-term-count] of turtles with [ color = orange ]

  set-current-plot "Short-term mating 2"
  ifelse (count turtles with [ color = turquoise and short-term-count > 0 ] != 0) [
    set-current-plot-pen "Male"
    plot (sum [short-term-count] of turtles with [ color = turquoise ])
      / (count turtles with [ color = turquoise and short-term-count > 0 ])
  ] [
    set-current-plot-pen "Male"
    plot 0
  ...
  ifelse (count turtles with [ color = orange and short-term-count > 0 ] != 0) [
    set-current-plot-pen "Female"
    plot (sum [short-term-count] of turtles with [ color = orange ])
      / (count turtles with [ color = orange and short-term-count > 0 ])
  ] [
    set-current-plot-pen "Female"
    plot 0
...
@#$#@#$#@
<experiments>
  <experiment name="likelihoodD_standardD_He" repetitions="2500" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="likelihoodD_standardS_He" repetitions="2500" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>starting-seed</metric>
  ...
  <experiment name="likelihoodS_standardD_He" repetitions="2500" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>starting-seed</metric>
  ...
  <experiment name="likelihoodS_standardS_He" repetitions="2500" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>starting-seed</metric>
  ...
  <experiment name="likelihoodD_standardD_Ho" repetitions="2500" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>starting-seed</metric>
  ...
  <experiment name="likelihoodD_standardS_Ho" repetitions="2500" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>starting-seed</metric>
  ...
  <experiment name="likelihoodS_standardD_Ho" repetitions="2500" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>starting-seed</metric>
  ...
  <experiment name="likelihoodS_standardS_Ho" repetitions="2500" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>starting-seed</metric>
