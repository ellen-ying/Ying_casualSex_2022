;; Model 2: revised logic for mating, short-term and long-term parallel, without desirability
...
to short-term-mate ;; turtle procedure: check to have short-term mating
  ...
  if (target != nobody) and (short-term-mate?) and ([short-term-mate?] of target) [
...
to update-plot ;; plotting procedure
  ;; plotting the mean number of shor-term sexual partners among males
  ...
  ;; plotting the mean number of shor-term sexual partners among females
  set-current-plot "Sexual partner vs. time"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot (count turtles with [coupled?]) / 2"
